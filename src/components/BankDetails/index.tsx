...
const BankDetails = () => {
  ...
  return (
    <div className="mt-4">
      ...
      <div className="mt-2">
        {activeTab === "1" && (
          <div className="flex flex-col w-164 border-2 rounded-md">
            <div className="flex border-b-2">
              <span className="w-40 border-r-2 py-2 pl-2">Одержувач:</span>
              <span className="py-2 pl-2">
                Благодійна організація «БФ «Україно рідна»:
              </span>
            </div>
            <div className="flex border-b-2">
              <span className="w-40 border-r-2 py-2 pl-2">IBAN:</span>
              <span className="py-2 pl-2">UA413806340000026000253207001</span>
            </div>
            <div className="flex border-b-2">
              <span className="w-40 border-r-2 py-2 pl-2">
                Банк отримувача:
              </span>
              <span className="py-2 pl-2">
            ...
            <div className="flex">
              <span className="w-40 border-r-2 py-2 pl-2">Код ЄДРПОУ:</span>
        ...
        {activeTab === "2" && (
          <div className="flex flex-col w-164 border-2 rounded-md">
            <div className="flex border-b-2">
              <span className="w-40 border-r-2 py-2 pl-2">Beneficiary:</span>
            ...
            <div className="flex">
              <span className="w-40 border-r-2 py-2 pl-2">SWIFT code:</span>
